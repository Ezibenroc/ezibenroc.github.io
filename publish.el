;; Adapted from https://github.com/dmacvicar/site.org
...
(defun duncan/head-common-list (plist)
  ...
  (let ((description "Website of Tom Cornebize"))
    (list
...
(defvar duncan--publish-project-alist
  (list
   ...
   (list "archive"
         ...
         :html-link-home "http://cornebize.net/"
   ...
   (list "site"
         :base-directory "./"
         :include '("posts/posts.org" "posts/archive.org" "README.org")
         :base-extension "org"
...
(defun duncan-publish-all ()
  ...
  (let ((make-backup-files nil)
        ...
        (user-full-name "Tom Cornebize")
        (user-mail-address "tom.cornebize@gmail.com")
